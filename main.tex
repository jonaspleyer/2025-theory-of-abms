...
\end{equation}
We integrate over the domain $\mathscr{D}$ and obtain use the total amount of extracellular compounds $\bar{\textbf{w}}$ instead of the previously used concentrations $\textbf{w}$ to reformulate the resulting equation.
...
The first term can be understood as an expectation value of a product of two distributions over living cells $c\in\CS$.
Assuming that the distribution of volumes $V_c$ and intracellular reactions is stochastically
independent, we can rewrite equation~\eqref{eq:pool-model-case1-coarse-grained-result}
\begin{equation}
    \partial_t\bar{\textbf{w}} =
    \text{E}\left(\frac{V_c}{V_\mathscr{D}}\right)\text{E}(\textbf{h}_{i,c}{\bar{\textbf{w}}})
    + \bar{\textbf{h}}_e(\bar{\textbf{w}})
    = \bar{\textbf{h}}(\bar{\textbf{w}}).
\end{equation}
where we have used the expectation value $\text{E}(\dots)$ to factorize the first term.
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.158\textwidth]
        ...
        \node at (0.025, 0.975)[anchor=north west, rectangle, draw, white, minimum width=10pt, minimum height=10pt]{\textbf{A}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.158\textwidth]
        {figures/sim-branching/diffusion-80/discretization-nvoxels-000080.png}
        \node at (0.025, 0.975)[anchor=north west, rectangle, draw, white, minimum width=10pt, minimum height=10pt]{\textbf{B}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.158\textwidth]
        {figures/sim-branching/diffusion-80/discretization-nvoxels-000042.png}%
        \node at (0.025, 0.975)[anchor=north west, rectangle, draw, white, minimum width=10pt, minimum height=10pt]{\textbf{C}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.158\textwidth]
        {figures/sim-branching/diffusion-80/discretization-nvoxels-000029.png}%
        \node at (0.025, 0.975)[anchor=north west, rectangle, draw, white, minimum width=10pt, minimum height=10pt]{\textbf{D}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.158\textwidth]
        {figures/sim-branching/diffusion-80/discretization-nvoxels-000022.png}%
        \node at (0.025, 0.975)[anchor=north west, rectangle, draw, white, minimum width=10pt, minimum height=10pt]{\textbf{E}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.158\textwidth]
        {figures/sim-branching/diffusion-80/discretization-nvoxels-000017.png}
        \node at (0.025, 0.975)[anchor=north west, rectangle, draw, white, minimum width=10pt, minimum height=10pt]{\textbf{F}};
    \end{tikzonimage}\\
    \includegraphics[width=\textwidth]{figures/fractal-combined-plot}
    % \begin{minipage}{0.5\textwidth}
    % \begin{tikzonimage}[width=1.0\textwidth]
    %     {figures/fractal-dim-box-size-scaling.pdf}
    %     \node at (0, 0.98)[anchor=north west, rectangle, draw, minimum width=10pt, minimum height=10pt]{\textbf{G}};
    % \end{tikzonimage}%
    % \end{minipage}%
    % \begin{minipage}{0.5\textwidth}
    %     \begin{tikzonimage}[width=0.5\textwidth]
    %         {figures/fractal-dim-vs-diffusion-constant.pdf}
    %         \node at (0, 0.98)[anchor=north west, rectangle, draw, minimum width=10pt, minimum height=10pt]{\textbf{H}};
    %     \end{tikzonimage}%
    %     \begin{tikzonimage}[width=0.5\textwidth]
    %         {figures/fractal-dim-over-time.pdf}
    %         \node at (0, 0.98)[anchor=north west, rectangle, draw, minimum width=10pt, minimum height=10pt]{\textbf{I}};
    %     \end{tikzonimage}\\
    %     \begin{tikzonimage}[width=1.0\textwidth]
    %         {figures/circle-packing}
    %         \node at (0, 0.98)[anchor=north west, rectangle, draw, minimum width=10pt, minimum height=10pt]{\textbf{J}};
    %     \end{tikzonimage}
    % \end{minipage}
    \caption{
        ...
        (J) Coarse-graining approach of combining multiple cells into one larger one.
