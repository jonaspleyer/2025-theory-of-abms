...
%---------------------------------------------------------------------------------------------------
\subsection{Trivial Reduction of a Bacterial Pool Model with Inter-species Competition}
...
\begin{table}[H]
    ...
    \begin{tabular}{clll}
        ...
        (C) & Mechanics & Damped Newtonian &
            $m \ddot{\vec{x}}_c = \vec{F} - \lambda \dot{\vec{x}}_c$\\
...
\begin{enumerate}
    ...
    \begin{align}
        \frac{\partial \vec{p}_k}{\partial k} &= \vec{f}(\vec{p}_k)\\
        \vec{p}_{k=1} &= \vec{p}_0
    \end{align}
